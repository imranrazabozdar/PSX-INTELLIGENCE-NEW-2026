# PSX Pre-Move Forensics: Complete 11-Stock Day-by-Day Report

**Report date:** 2026-09-05
**Source analysis date:** 2026-09-03
**Data period:** 2026-03-15 to 2026-09-03 (varies per stock; each stock's window covers ~11 days before to ~11+ days after its reference move-start date)
**Data source:** Pakistan Stock Exchange (PSX) Data Portal (`dps.psx.com.pk/historical`) via `backend/dps_scraper.py`
**Source file:** `analysis/AICL_SHFA_premove_study.md`

## Coverage

This report consolidates the complete day-by-day forensic tables and narratives for **11 stocks** from the PSX pre-move pattern study. A 12th stock (BNL) was excluded due to a ticker/price mismatch — the fetched PSX data for `BNL` did not match the user-stated reference prices at either endpoint, with no corporate-action event to explain the ~10x discrepancy.

| # | Ticker | Report window | Key move description |
|---|--------|--------------|---------------------|
| 1 | AICL | 2026-07-08 to 2026-08-07 | Flush-out low 73.02 on 07-23, Bullish Engulfing 07-24, volume breakout 8.70x on 07-28 |
| 2 | SHFA | 2026-05-28 to 2026-06-18 | Tight consolidation base, violent breakout 06-17 (+8.65% on 3.80x volume) |
| 3 | THCCL | 2026-06-15 to 2026-07-09 | Volume breakout 07-07 (3.79x), Bullish Engulfing 07-09 |
| 4 | FNEL | 2026-03-22 to 2026-04-24 | Breakout 04-08 (+31.2% on 8.65x, 212M shares); price-cliff 2026-02-02 (bonus/rights) |
| 5 | MDTL | 2026-07-08 to 2026-07-27 | Same-day confirmation on 07-24 (6.52x volume + MACD flip + Bullish Engulfing) |
| 6 | FPJM | 2026-07-29 to 2026-09-03 | Largest % move (+177%), slow grind then breakout 08-18 (2.76x) |
| 7 | DSIL | 2026-07-16 to 2026-08-12 | Early signals (>2x volume Day -10, Piercing Line Day -6, EMA golden cross Day -5) |
| 8 | SYM | 2026-04-10 to 2026-07-03 | Multi-month grind, no single clean breakout day; widest window (55 trading days) |
| 9 | PREMA | 2026-03-15 to 2026-04-27 | BB -2.2 sigma at move-start (03-30), breakout 04-14 (3.24x), EMA golden cross 04-24 |
| 10 | JSBL | 2026-05-04 to 2026-06-02 | 10.7x volume spike Day -9 (05-06), Bullish Engulfing Day +4, breakout Day +5 (05-29, 2.6x) |
| 11 | ILP | 2026-05-18 to 2026-06-30 | 9.5x volume spike Day +2 (06-04) as breakout, acceleration 06-12 to 06-30 closing at 107.54 |

## Column explanations

### Core day-by-day table columns

| Column | Description |
|--------|-------------|
| Date | Trading date (PSX calendar; gaps = weekends/holidays) |
| Open, High, Low, Close | OHLC prices in PKR |
| Volume | Shares traded |
| Vol 20d avg | 20-day trailing average volume |
| Vol ratio | Volume / Vol 20d avg |
| Candle pattern | Detected candlestick pattern (Bullish Engulfing, Morning Star, Hammer, Doji, Piercing Line) |
| Pattern criteria met | Exact numeric criteria that triggered the pattern detection |
| Price vs MA20 / MA50 | Close relative to SMA(20) and SMA(50) |
| BB position | Price position vs Bollinger Bands(20,2) in sigma units |
| MACD hist | MACD(12,26,9) histogram value |
| MACD dir | Whether MACD histogram is rising or falling vs prior bar |
| EMA20 vs EMA50 | EMA(20) vs EMA(50) — golden cross when EMA20 > EMA50 |
| RSI(14) | Relative Strength Index (14-period, Wilder-smoothed) |
| Support/resistance note | Swing-point tests from retrospective +/-3-bar scan |

### Volume & flow table columns

| Column | Description |
|--------|-------------|
| MFI(14) | Money Flow Index — volume-weighted RSI (14-period, simple rolling sums) |
| OBV | On-Balance Volume — cumulative close-to-close direction-weighted volume |
| A/D Line | Accumulation/Distribution Line — cumulative, weighted by close position within high-low range |
| ATR(14) | Average True Range (14-period, Wilder-smoothed), in price units |
| VWAP | Window-anchored approximation: cumulative volume-weighted `(H+L+C)/3`, restarting at each window's first day. **Not** a real intraday VWAP. |
| Price vs VWAP | Whether close is above or below the window-anchored VWAP |
| Tenkan-sen / Kijun-sen | Ichimoku Cloud conversion/base lines (9/26 periods) |
| Ichimoku cloud | Cloud position (above/below/inside), color (bullish green / bearish red), thickness |
| Flow divergence | OBV vs A/D Line disagreements and divergences from price |

### Indicator computation notes

- All indicators computed over an extended lookback (~70 calendar days before each window) so every reported day has genuine trailing history.
- Candlestick pattern rules are literal, classic textbook definitions, unit-tested against synthetic OHLC.
- Support/resistance from retrospective swing-point scan (+/-3-bar window) — descriptive, not a causal/live trading signal.
- Price-cliff detector (generalized): scans for close drops >30% from prior close with volume >3x trailing 10-day avg. Found FNEL's 2026-02-02 bonus-share cliff; found zero for all other stocks.
- Ichimoku cloud readings for the last ~26 days of any window are provisional (forward-displaced from in-window data).
...
**AICL:** Flush-out-and-reversal: drift into a low, Bullish Engulfing at the bottom, then volume breakout (8.70x) three days later.
...
**SHFA:** Tight-base breakout: 10-day consolidation with deeply oversold MFI, then violent single-day breakout (+8.65% on 3.80x volume).
...
**THCCL:** Slow-grind accumulation: gradual volume build over 9 days, then 3.79x volume breakout with Bullish Engulfing confirmation.
...
**FNEL:** Two-stage rocket: initial breakout day (+31.2% on 8.65x, 212M shares), then a second accumulation leg (OBV build) before further extension.
...
**MDTL:** Same-day triple confirmation: 6.52x volume spike + MACD histogram sign flip + Bullish Engulfing all on a single session (Day +1).
...
**FPJM:** Slow grind then breakout: largest % move (+177%), weeks of gradual ascent, then 2.76x breakout on Day +2 triggers acceleration.
...
**DSIL:** Early-signal leader: >2x volume Day -10, Piercing Line Day -6, EMA golden cross Day -5 — all well before reference move-start.
...
**SYM:** Multi-month grind: widest window (55 trading days), no single clean breakout day; EMA golden cross arrives Day +37, Bullish Engulfing Day +37.
...
**PREMA:** BB-extreme capitulation base: -2.2 sigma at move-start, Hammer + Doji pre-move patterns, breakout day (3.24x) arrives Day +11, golden cross Day +19.
...
**JSBL:** Panic-volume washout: 10.7x volume spike Day -9 well before move-start, Bullish Engulfing Day +4, MACD flip and breakout Day +5.
...
**ILP:** Volume-spike breakout: shallow choppy base (78-84 range), then 9.5x single-day volume spike on Day +2 as breakout, gradual acceleration to +35% over next 18 days.

---

## Cross-stock first-occurrence comparison (11 stocks)

For all eleven reliably-identified stocks in the dataset, the day (relative to each stock's own move-start date, Day 0) each signal first appears in its report window. BNL is excluded due to the ticker/price mismatch disclosed above.

| Signal | AICL | SHFA | THCCL | FNEL | MDTL | FPJM | DSIL | SYM | PREMA | JSBL | ILP |
|---|---|---|---|---|---|---|---|---|---|---|---|
| First volume >2x avg | Day -11 (2026-07-08) | Day -8 (2026-06-02) | Day +5 (2026-07-07) | Day +2 (2026-04-08) | Day +1 (2026-07-24) | Day +2 (2026-08-18) | Day -10 (2026-07-17) | Day -10 (2026-04-16) | Day +7 (2026-04-08) | Day -9 (2026-05-06) | Day +2 (2026-06-04) |
| First candlestick pattern | Day -9 (2026-07-10) | Day -4 (2026-06-08) | Day +3 (2026-07-03) | Day 0 (2026-04-06) | Day -6 (2026-07-15) | Day -7 (2026-08-04) | Day -6 (2026-07-23) | Day -11 (2026-04-15) | Day -6 (2026-03-18) | Day +4 (2026-05-25) | Day -6 (2026-05-20) |
| First BB oversold (<=-1.5 sigma) | Day -7 (2026-07-14) | Day -7 (2026-06-03) | not observed in window | not observed in window | Day -7 (2026-07-14) | not observed in window | not observed in window | Day +1 (2026-05-04) | Day 0 (2026-03-30) | Day -9 (2026-05-06) | Day -8 (2026-05-18) |
| First MACD hist sign change (neg->pos) | Day +3 (2026-07-28) | Day 0 (2026-06-12) | Day +5 (2026-07-07) | not observed in window | Day +1 (2026-07-24) | Day +3 (2026-08-19) | Day -10 (2026-07-17) | Day +8 (2026-05-13) | not observed in window | Day +5 (2026-05-29) | Day +5 (2026-06-09) |
| First EMA20/50 golden cross | Day +2 (2026-07-27) | Day +1 (2026-06-15) | not observed in window | Day +13 (2026-04-23) | not observed in window | not observed in window | Day -5 (2026-07-24) | Day +37 (2026-06-30) | Day +19 (2026-04-24) | not observed in window | not observed in window |
| Breakout day (vol>=2.5x + up day) | Day +3 (2026-07-28) | Day +3 (2026-06-17) | Day +5 (2026-07-07) | Day +2 (2026-04-08) | Day +1 (2026-07-24) | Day +2 (2026-08-18) | Day +1 (2026-08-03) | Day -3 (2026-04-27) | Day +11 (2026-04-14) | Day +5 (2026-05-29) | Day +2 (2026-06-04) |
...
BNL (Stock 12 in the original study) was excluded from this forensic report due to a ticker/price mismatch. The user's reference prices (~2.10 and ~17.10) did not match the fetched PSX data for `BNL` (~23.20 and ~160.09) at either endpoint — a consistent ~10x factor with no corporate-action event to explain it. The price-cliff detector (which correctly found FNEL's bonus-share adjustment) found zero qualifying discontinuities in BNL's 149-bar series. Raw data is preserved in `analysis/premove_data_raw.json` and `analysis/premove_analysis.json` under the `BNL` key.
